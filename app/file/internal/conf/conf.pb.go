...
func (x *Data_Kafka) GetTransferTopic() string {
	if x != nil {
		return x.TransferTopic
	}
	return ""
}

func (x *Data_Kafka) GetThumbnailTopic() string {
	if x != nil {
...
const file_conf_proto_rawDesc = "" +
	...
	"\x05kafka\x18\x03 \x01(\v2\x16.kratos.api.Data.KafkaR\x05kafka\x1a\xb5\x01\n" +
	"\bDatabase\x12\x16\n" +
