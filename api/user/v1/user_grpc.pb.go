...
const (
	...
	UserService_UpdateUserInfo_FullMethodName    = "/api.user.v1.UserService/UpdateUserInfo"
	UserService_UpdateStorageUsed_FullMethodName = "/api.user.v1.UserService/UpdateStorageUsed"
)
...
func (c *userServiceClient) UpdateStorageUsed(ctx context.Context, in *UpdateStorageUsedRequest, opts ...grpc.CallOption) (*UpdateStorageUsedReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateStorageUsedReply)
	err := c.cc.Invoke(ctx, UserService_UpdateStorageUsed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) UpdateStorageUsed(context.Context, *UpdateStorageUsedRequest) (*UpdateStorageUsedReply, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateStorageUsed not implemented")
}
...
func _UserService_UpdateStorageUsed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateStorageUsedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).UpdateStorageUsed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpdateStorageUsed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateStorageUsed(ctx, req.(*UpdateStorageUsedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateStorageUsed",
			Handler:    _UserService_UpdateStorageUsed_Handler,
		},
	},
